...
var maxSize = '9999'; var ZipmaxSize = '5120'; var message = "File is exceeding the allowed limit of 5 MB. Please choose another file";
...
var validExtpdfxlsx = ".png, .jpeg, .jpg ,.pdf, .doc , .xlsx , .docx , .xls";
function fileExtValidateimgpdfxlsx(fdata) {
    var filePath = fdata.value;
    var getFileExt = filePath.substring(filePath.lastIndexOf('.') + 1).toLowerCase();
