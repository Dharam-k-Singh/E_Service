...
namespace DAL
{
    public class SqlManager
    {
        ...
        {
            //SqlConnection sqlConnection = new SqlConnection(@"Server=DESKTOP-HMO05CP\SQLEXPRESS;Database=ictp;user id=sa;pwd=123");
            //SqlConnection sqlConnection = new SqlConnection(@"Server=S148-66-129-50\SQLEXPRESS;Database=LFZ_EservicePortal;user id=sa;pwd=Zaksof@123");
            //SqlConnection sqlConnection = new SqlConnection(@"Server=S208-109-11-207;Database=LFZ_EservicePortalAPICore;user id=sa;pwd=Zaksof@123");
            //SqlConnection sqlConnection = new SqlConnection(@"Server=S208-109-11-207;Database=LFZ_EservicePortalAPICore;user id=sa;pwd=Zaksof@123");
